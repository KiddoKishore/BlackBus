import { UpdateTrip, checkSeats, createTicket, findTicket, findTrip, getTickets, cancel, update } from '../../Service/ticketService';
import {
    BookTrip,
    getTicketById,
    getAllTickets,
...
jest.mock('../../Service/ticketService.js', () => ({
    findTrip: jest.fn(),
    findTicket: jest.fn(),
    getTickets: jest.fn(),
    cancel: jest.fn(),
    ...
    it('Ticket already canceled', async () => {
        const canceledTicket = {
          _id: 'ticketId',
            ...
            busNumber: 'TN38',
            bookingDate: '2024-01-12',
            passengers: [{name: 'Kishore',age: 19,seatNo: 3}],
            numberOfSeats: '1',
            date: '2024-01-15',
            departureTime: '08:00',
            arrivalTime: '12:00',
